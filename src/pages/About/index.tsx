  ...
  return (
    <Layout id="about">
      <div className="w-full md:w-1/2 flex flex-col gap-4 pr-4">
        <h1 className="font-semibold text-3xl gradient-animation">Sobre mi</h1>
      ...
      <div className="w-full md:w-1/2 flex h-fit flex-col gap-4">
        <h1 className="font-semibold text-3xl gradient-animation">Experiencia</h1>
        {experience && experience.map((exp: ExperienceType) => (
          <p className=" flex flex-col font-light text-lg" key={exp.company}>
            <span className="font-medium text-amber-500">{exp.position}</span>
